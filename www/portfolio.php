...
<body class="portfolio">
	<div id="PageWrapper">
		...
		<div id="MainContent" role="main">
			...
			<div id="mContainer">
				<ul>
					<li><a href="/portfolio_item.php">	<img src="/media/images/portfolio/thumb/hero/0003_BleepingClean.jpg" width="260" height="260" alt="0003 BleepingClean"></a></li>
					<li><a href="/portfolio_item.php">	<img src="/media/images/portfolio/thumb/hero/0010_BlackMamba.jpg" width="260" height="260" alt="0010 BlackMamba"></a></li>
					<li><a href="/portfolio_item.php">	<img src="/media/images/portfolio/thumb/hero/0012_GE-Airshow.jpg" width="260" height="260" alt="0012 GE Airshow"></a></li>
					<li><a href="/portfolio_item.php">	<img src="/media/images/portfolio/thumb/hero/0019_FacebookStudioAwards.jpg" width="260" height="260" alt="0019 FacebookStudioAwards"></a></li>
					<li><a href="/portfolio_item.php">	<img src="/media/images/portfolio/thumb/hero/0024_jameson.jpg" width="260" height="260" alt="0024 Jameson"></a></li>
					<li><a href="/portfolio_item.php">	<img src="/media/images/portfolio/thumb/hero/0027_TrashSmart2.jpg" width="260" height="260" alt="0027 TrashSmart2"></a></li>
					<li><a href="/portfolio_item.php">	<img src="/media/images/portfolio/thumb/hero/GladBlackBag2.jpg" width="260" height="260" alt="GladBlackBag2"></a></li>
					<li><a href="/portfolio_item.php">	<img src="/media/images/portfolio/thumb/hero/thumb_SU11.jpg" width="260" height="260" alt="Thumb SU11"></a></li>
				</ul>
			</div>
		</div>
